...
<html lang="vi">
   <head>
      ...
      <link rel='stylesheet' id='bootstrap-css' href='/web/css/bootstrap.min.css?ver=5.7.2' media='all' />
      <link rel='stylesheet' id='style-css' href='/web/css/style.css?ver=5.7.2' media='all' />
      <link rel='stylesheet' id='wp-block-library-css' href='/web/css/style.min.css?ver=5.7.2' media='all' />
      <script type='text/javascript' src='/web/js/jquery.min.js?ver=5.7.2' id='halim-jquery-js'></script>
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
               ...
               <div class="collapse navbar-collapse" id="halim">
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        <li class="current-menu-item active"><a title="Trang Chủ" href="{{ route('web.home')}}">Trang Chủ</a></li>
                        @foreach($categories as $category)
                        <li class="mega"><a title="{{ $category->title}}" href="{{ route('web.category',$category->slug)}}">{{ $category->title}}</a></li>
                        @endforeach
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              ...
                              <li><a title="{{ $genre->title }}" href="{{ route('web.genre',$genre->slug)}}">{{ $genre->title }}</a></li>
                              @endforeach
                           </ul>
                        </li>
                        <li class="mega dropdown">
                           ...
                           @foreach($countries as $country)
                              <li><a title="{{ $country->title }}" href="{{ route('web.country',$country->slug)}}">{{ $country->title }}</a></li>
                             @endforeach
                           </ul>
                        </li>
      ...
      <footer id="footer" class="clearfix" style="text-align:center">
         <div class="container footer-columns">
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-12">
                  <div class="footer-logo">
                     <img class="img-responsive" src="/image/logo_mephim.png" alt="Phim hay 2021- Xem phim hay nhất" />
                  </div>
      ...
      <script type='text/javascript' src='/web/js/bootstrap.min.js?ver=5.7.2' id='bootstrap-js'></script>
      <script type='text/javascript' src='/web/js/owl.carousel.min.js?ver=5.7.2' id='carousel-js'></script>
     
      <script type='text/javascript' src='/web/js/halimtheme-core.min.js?ver=1626273138' id='halim-init-js'></script>
      ...
      <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v13.0" nonce="4CQd2fIl"></script>
   </body>
</html>