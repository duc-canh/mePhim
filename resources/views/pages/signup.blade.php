                        ...
                        <form role="form" action="{{ route('admin.user.store')}}" method="POST">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="comfirm_password" type="password" placeholder="Please Enter again Password" />
                                </div>
                                <div class="form-group">
                                   
                                    <label class="radio-inline">
                                        <input name="is_admin" value="1" checked="" type="radio">User
                                    </label>
