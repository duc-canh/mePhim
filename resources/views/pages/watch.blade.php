      ...
      <div class="row container" id="wrapper">
         <div class="halim-panel-filter">
            <div class="panel-heading">
               <div class="row">
                  <div class="col-xs-6">
                     <div class="yoast_breadcrumb hidden-xs"><span><span><a href="{{ route('web.genre',$movie_watch->genre->slug )}}">{{ $movie_watch->genre->title}}</a> » <span><a href="{{ route('web.country',$movie_watch->country->slug )}}">{{ $movie_watch->country->title}}</a> » <span class="breadcrumb_last" aria-current="page">{{ $movie_watch->title }}</span></span></span></span></div>
                  </div>
               </div>
            </div>
         ...
         <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
            <section id="content" class="test">
               ...
               <iframe width="100%" height="500" src="{{ $movie_watch->episodes[0]->link_movie}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  ...
                  <div class="title-block">
                     ...
                     <div class="title-wrapper-xem full">
                        <h1 class="entry-title"><a href="" title="{{ $movie_watch->title }}" class="tl">{{ $movie_watch->title }}</a></h1>
                     </div>
                  </div>
                        ...
                        <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                           <div class="halim-server">
                              <ul class="halim-list-eps">
                                 ...
                                 @foreach($movie_episodes as $episode)
                                 <a href="{{ route('web.episode',[$episode->movie->slug,$episode->episodes] )}}"><li class="halim-episode"><span class="halim-btn halim-btn-2 active halim-info-1-1 box-shadow" data-post-id="37976" data-server="1" data-episode="1" data-position="first" data-embed="0" data-title="{{ $episode->movie->sulg }}" data-h1="{{ $episode->movie->sulg }}">{{ $episode->episodes }}</span></li></a>
